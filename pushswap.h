...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/28 19:00:02 by mllamas-          #+#    #+#             */
/*   Updated: 2023/11/30 09:41:20 by mllamas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#ifndef PUSHSWAP_H
# define PUSHSWAP_H
...
void		ft_do_b(t_element **top_a, t_element **top_b, int index, int lena);
...
int			r_dest(t_element *a, t_element *top_b, int len);
